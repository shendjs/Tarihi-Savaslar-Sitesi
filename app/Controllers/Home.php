...
class Home extends BaseController
{
    ...
    {
        $warModel = new \App\Models\WarModel();
        $wars = $warModel->getAllWars(); // Tüm savaşları çekiyoruz
    
        return view('index', ['wars' => $wars]);
    }
    

    public function generic()
    {
        return view('generic'); // Generic sayfası
    }
    
    public function elements()
    {
        return view('elements'); // Elements sayfası
    }
